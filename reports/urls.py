...
from reports.views.pdf_purchase_invoice import PurchaseInvoicePdfView
...
urlpatterns = [
    ...
    path("pdf/purchase-invoice/<int:pk>/worker", PurchaseInvoicePdfView.as_view(), name="purchase-invoice-pdf",),
]
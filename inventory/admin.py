...
class ProductAdmin(admin.ModelAdmin):
    list_display = ('id', 'date', 'filial', 'branch', 'branch_category', 'model', 'type', 'size', 'count', 'real_price', 'unit_price', 'wholesale_price', 'min_price', 'is_delete', 'is_active')
    ...
    search_fields = ('note', 'filial__name', 'branch__name', 'branch_category__name', 'model__name', 'type__name', 'real_price')

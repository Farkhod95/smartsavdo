...
class ProductModelListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ProductModel
        fields = ('id', 'name', 'branch_name', 'branch_category', 'branch_category_detail', 'sorting', 'is_delete')
...
class ProductModelSerializer(serializers.ModelSerializer):
    ...
    def _suggest_next_sorting(self, branch_category_id: int) -> int:
        max_sorting = (
    ...
    def validate(self, attrs):
        ...
        if qs.exists():
            suggestion = self._suggest_next_sorting(branch_category_id=branch_category.id)

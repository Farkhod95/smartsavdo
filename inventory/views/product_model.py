...
class ProductModelFieldInfoView(APIView):
...
class ProductModelViewList(ListCreateAPIView):
    """
    ...
    search_fields = ('name', 'branch__name', 'branch_category__name')
    ordering = ['sorting', '-id']
...
class ProductModelView(ListCreateAPIView):
...
class ProductModelDetailView(RetrieveUpdateDestroyAPIView):
    serializer_class = ProductModelSerializer
    ...
    def get(self, request, pk):
        ...
        serializer = ProductModelListSerializer(instance)
